...
const constituencyData = {
    "Andhra Pradesh": {
        "Araku": ["Palakonda", "Kurupam", "Parvathipuram", "Salur", "Araku Valley", "Paderu", "Rampachodavaram"],
        "Srikakulam": ["Ichchapuram", "	Palasa", "Tekkali", "Pathapatnam", "Srikakulam", "Amadalavalasa", "Narasannapeta"],
        "Vizianagaram": ["Etcherla", "Rajam", "Bobbili", "Cheepurupalli", "Gajapathinagaram", "	Nellimarla", "Vizianagaram"],
        "Visakhapatnam": ["Srungavarapukota", "Bheemili", "Visakhapatnam East", "Visakhapatnam South", "Visakhapatnam North", "Visakhapatnam West", "Gajuwaka"],
        "Anakapalli": ["Chodavaram", "Madugula", "Anakapalli", "Pendurthi", "Elamanchili", "Payakaraopet ", "Narsipatnam"],
        "Kakinada": ["Tuni", "Prathipadu", "Pithapuram", "Kakinada Rural", "Peddapuram", "Kakinada City", "Jaggampeta"],
        "Amalapuram": ["Ramachandrapuram", "Mummidivaram", "Amalapuram", "Razole", "Gannavaram", "Kothapeta", "Mandapeta"],
        "Rajahmundry": ["Anaparthy", "Rajanagaram", "Rajahmundry City", "Rajahmundry Rural", "Kovvur", "Nidadavole", "Gopalapuram"],
        "Narasapuram": ["Achanta", "Palakollu", "Narasapuram", "Bhimavaram", "Undi", "Tanuku", "Tadepalligudem"],
        "Eluru": ["Unguturu", "Denduluru", "Eluru", "Polavaram", "Chintalapudi", "Nuzvid", "Kaikalur"],
        "Machilipatnam": ["Gannavaram", "Gudivada", "Pedana", "	Machilipatnam", "Avanigadda", "Pamarru", "Penamaluru"],
        "Vijayawada": ["Tiruvuru", "Vijayawada West", "Vijayawada Central", "Vijayawada East", "Mylavaram", "Nandigama", "Jaggayyapeta"],
        "Guntur": ["Tadikonda", "Mangalagiri", "Ponnur", "Tenali", "Prathipadu", "Guntur West", "Guntur East"],
        "Narasaraopet": ["Pedakurapadu", "Chilakaluripet", "Narasaraopet", "Sattenapalle", "Vinukonda", "Gurazala", "Macherla"],
        "Bapatla": ["Vemuru", "Repalle", "Bapatla", "Parchur", "Addanki", "Chirala", "Santhanuthalapadu"],
        "Ongole": ["Yerragondapalem", "Darsi", "Ongole", "Kondapi", "Markapuram", "Giddalur", "Kanigiri"],
        "Nandyal": ["Allagadda", "Srisailam", "Nandikotkur", "Panyam", "Nandyal", "Banaganapalle", "Dhone"],
        "Kurnool": ["Kurnool", "Pattikonda", "Kodumur", "Yemmiganur", "Mantralayam", "Adoni", "Alur"],
        "Anantapur": ["Rayadurgam", "Uravakonda", "Guntakallu", "Tadpatri", "Singanamala", "Anantapuram Urban", "Kalyandurgam"],
        "Hindupur": ["Raptadu", "Madakasira", "Hindupur", "Penukonda", "Puttaparthi", "Dharmavaram", "Kadiri"],
        "Kadapa": ["Badvel", "Kadapa", "Pulivendla", "Kamalapuram", "Jammalamadugu", "Proddatur", "Mydukur"],
        "Nellore": ["Kandukur", "Kavali", "Atmakur", "Kovuru", "Nellore City", "Nellore Rural", "Udayagiri"],
        "Tirupati": ["Sarvepalli", "Gudur", "Sullurpeta", "	Venkatagiri", "Tirupati", "Srikalahasti", "Satyavedu"],
        "Rajampet": ["Rajampet", "Kodur", "Rayachoti", "Thamballapalle", "Pileru", "Madanapalle", "Punganur"],
        "Chittoor": ["Chandragiri", "Nagari", "Gangadhara Nellore", "Chittoor", "Puthalapattu", "Palamaner", "Kuppam"],
        // Add more parliament constituencies and corresponding assembly constituencies for Andhra Pradesh
    },
    "Arunachal Pradesh": {
        "Arunachal West": ["Lumla", "Tawang", "Mukto", "Dirang", "Kalaktang", "Thrizino-Buragaon", "Bomdila", "Bameng", "Chayangtajo", "Seppa East", "Seppa West", "Pakke-Kessang", "Itanagar", "Doimukh", "Sagalee", "Yachuli", "Ziro-Hapoli", "Palin", "Nyapin", "Tali", "Koloriang", "Nacho", "Taliha", "Daporijo", "Raga", "Dumporijo", "Liromoba", "Likabali", "Basar", "Along West", "Along East", "Rumgong", "Mechuka"],
        "Arunachal East": ["Tuting-Yingkiong", "Pangin", "Nari-Koyu", "Pasighat West", "Pasighat East", "Mebo", "Mariyang-Geku", "Anini", "Dambuk", "Roing", "Tezu", "Hayuliang", "Chowkham", "Namsai", "Lekang", "Bordumsa-Diyun", "Miao", "Nampong", "Changlang South", "Changlang North", "Namsang", "Khonsa East", "Khonsa West", "Borduria-Bogapani", "Kanubari", "Longding-Pumao", "Pongchau-Wakka"],
        // Add more parliament constituencies and corresponding assembly constituencies for Andhra Pradesh
    },
    "Assam": {
...
const input2Details = document.querySelectorAll(".input2");
const signupButton = document.getElementById("signUp");

if (inputDetails.length > 0 || input2Details.length > 0) {
    populateParliamentDropdown(selectedState);
    populateAssemblyDropdown(selectedState, selectedParliament);
